...
const allTranslations: Translations = {
  ...
  "admin.manageBanners": { en: "Banner Management", he: "ניהול באנרים" },
  "admin.bannerDescription": { en: "Customize your boutique's visual storytelling", he: "התאם אישית את הסיפור הוויזואלי של הבוטיק שלך" },
  "admin.addNewBanner": { en: "Add New Banner", he: "הוסף באנר חדש" },
  "admin.bannerTitle": { en: "Banner Title", he: "כותרת באנר" },
  "admin.targetLink": { en: "Target Link", he: "קישור יעד" },
  "admin.saveChanges": { en: "Save Changes", he: "שמור שינויים" },
