...
const allTranslations: Translations = {
  ...
  "checkout.phone": { en: "Phone Number", he: "מספר טלפון" },
  "checkout.state": { en: "State / District", he: "מחוז / אזור" },
  "checkout.country": { en: "Country", he: "מדינה" },
  "profile.myAccount": { en: "My Account", he: "החשבון שלי" },
  "profile.personalInfo": { en: "Personal Information", he: "פרטים אישיים" },
  "profile.addresses": { en: "Addresses", he: "כתובות למשלוח" },
  "profile.preferences": { en: "Preferences", he: "העדפות אישיות" },
  ...
  "profile.marketingEmails": { en: "Marketing & Offers", he: "עדכונים ומבצעים" },
  "profile.smsNotifications": { en: "SMS Notifications", he: "הודעות SMS" },
  ...
  "admin.subcategory": { en: "Subcategory", he: "תת-קטגוריה" },
  "admin.subcategoryEn": { en: "Subcategory (EN)", he: "תת-קטגוריה (אנגלית)" },
  "admin.subcategoryHe": { en: "Subcategory (HE)", he: "תת-קטגוריה (עברית)" },
  "admin.selectSubcategory": { en: "Select Subcategory", he: "בחר תת-קטגוריה" },
  "admin.parentCategory": { en: "Parent Category (Optional)", he: "קטגוריית אם (רשות)" },
  "admin.mainCategory": { en: "Main Category (Top Level)", he: "קטגוריה ראשית" },
  ...
  "admin.onlineVisitors": { en: "Online Visitors", he: "מבקרים אונליין" },
  "admin.liveSystemStatus": { en: "Live System Status", he: "סטטוס מערכת בזמן אמת" },
  "admin.updatedLive": { en: "Updated Live", he: "מעודכן בזמן אמת" },
  "admin.revenuePerformance": { en: "Revenue Performance (Last 30 Days)", he: "ביצועי הכנסות (30 ימים אחרונים)" },
  "admin.orderVolumeTrends": { en: "Order Volume Trends", he: "מגמות נפח הזמנות" },
  "admin.recentOrders": { en: "Recent Orders", he: "הזמנות אחרונות" },
  "admin.noOrdersYet": { en: "No orders found yet.", he: "לא נמצאו הזמנות עדיין." },
  "admin.guest": { en: "Guest", he: "אורח" },
  "admin.delivered": { en: "Delivered", he: "נמסר" },
  "admin.paid": { en: "Paid", he: "שולם" },
  "admin.pending": { en: "Pending", he: "בהמתנה" },
  "admin.processing": { en: "Processing", he: "בטיפול" },
  ...
  "admin.piercingSide": { en: "Piercing Side", he: "צד פירסינג" },
  "admin.unitType": { en: "Unit Type", he: "סוג יחידה" },
  "admin.pipeLength": { en: "Pipe Length (e.g. 1cm)", he: "אורך מוט (למשל 1 ס״מ)" },
  "admin.metalColorsAndImages": { en: "Available Metal Colors & Images", he: "צבעי מתכת ותמונות זמינים" },
  "admin.variantImageUrl": { en: "Variant Image URL", he: "קישור לתמונת וריאנט" },
  "admin.none": { en: "None", he: "ללא" },
  "admin.right": { en: "Right", he: "ימין" },
  "admin.left": { en: "Left", he: "שמאל" },
  "admin.both": { en: "Both", he: "שניהם" },
  "admin.singleEarring": { en: "Single Earring", he: "עגיל בודד" },
  "admin.pairSet": { en: "2 Pair (Set)", he: "זוג עגילים" },
  ...
  "admin.manageCategories": { en: "Manage product collections", he: "ניהול קולקציות המוצרים" },
  "admin.addNewCategory": { en: "Add New Category", he: "הוסף קטגוריה חדשה" },
  "admin.saveCategory": { en: "Save Category", he: "שמור קטגוריה" },
  "admin.descriptionEn": { en: "Description (EN)", he: "תיאור (אנגלית)" },
  "admin.descriptionHe": { en: "Description (HE)", he: "תיאור (עברית)" },
  "admin.slug": { en: "Slug", he: "מזהה URL (Slug)" },
  ...
  "admin.backgroundType": { en: "Background Type", he: "סוג רקע" },
  "admin.staticImage": { en: "Static Image", he: "תמונה סטטית" },
  "admin.backgroundVideo": { en: "Background Video", he: "וידאו רקע" },
  "admin.solidBlack": { en: "Solid Black Color", he: "צבע שחור מלא" },
  "admin.mainImagePoster": { en: "Main Image / Video Poster", he: "תמונה ראשית / פוסטר וידאו" },
  "admin.videoUrl": { en: "Video URL (MP4)", he: "קישור לוידאו (MP4)" },
  "admin.targetLink": { en: "Target Link", he: "קישור יעד" },
  "admin.saveChanges": { en: "Save Design", he: "שמור עיצוב" },
  "admin.preview": { en: "Preview", he: "תצוגה מקדימה" },
  "admin.type": { en: "Type", he: "סוג" },
  ...
  "admin.manageCustomers": { en: "Manage your boutique's clientele", he: "ניהול לקוחות הבוטיק" },
  "admin.email": { en: "Email", he: "אימייל" },
  "admin.role": { en: "Role", he: "תפקיד" },
  "admin.noPhone": { en: "No phone", he: "ללא טלפון" },
  "admin.confirmDeleteUser": { en: "Are you sure you want to delete this user?", he: "האם אתה בטוח שברצונך למחוק משתמש זה?" },
  "admin.managePrizes": { en: "Manage the rewards for your boutique's lucky wheel", he: "ניהול הפרסים בגלגל המזל של הבוטיק" },
  "admin.addNewPrize": { en: "Add New Prize", he: "הוסף פרס חדש" },
  "admin.labelEn": { en: "Label (EN)", he: "תווית (אנגלית)" },
  "admin.labelHe": { en: "Label (HE)", he: "תווית (עברית)" },
  "admin.couponValue": { en: "Coupon Value/Code", he: "קוד/ערך קופון" },
  "admin.weightChance": { en: "Weight/Chance", he: "משקל/סיכוי" },
  "admin.savePrize": { en: "Save Prize", he: "שמור פרס" },
  ...
  "metal.black": { en: "Black", he: "שחור" },
  "admin.materialsEn": { en: "Materials (EN)", he: "חומרים (אנגלית)" },
  "admin.materialsHe": { en: "Materials (HE)", he: "חומרים (עברית)" },
