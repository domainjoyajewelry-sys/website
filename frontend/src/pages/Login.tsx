...
const Login: React.FC = () => {
  ...
  const handleFacebookLogin = () => {
    alert("Facebook OAuth Flow initiated...");
  };
  ...
  return (
    <div className="min-h-screen pt-40 pb-20 px-6 bg-zinc-50 flex items-center justify-center">
      <motion.div 
        ...
        className="w-full max-w-md bg-white p-12 shadow-2xl border border-zinc-100"
      >
        <div className="text-center mb-12">
          <h1 className="text-4xl font-serif uppercase tracking-widest mb-4 font-medium">
            {language === 'he' ? 'התחברות' : 'Sign In'}
          </h1>
          <p className="text-[10px] uppercase tracking-[0.5em] text-zinc-400 font-serif">
        ...
        <form onSubmit={handleLogin} className="space-y-8 mb-10">
          <div className="space-y-4">
            <Label className="text-[10px] uppercase tracking-widest font-bold font-serif">Email</Label>
            <Input 
              type="email" 
              required 
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              className="rounded-none border-zinc-300 focus-visible:ring-black h-12"
            />
          </div>
          <div className="space-y-4">
            <Label className="text-[10px] uppercase tracking-widest font-bold font-serif">Password</Label>
            <Input 
              type="password" 
              required 
              value={password}
          ...
          <Button type="submit" className="w-full bg-black text-white hover:bg-zinc-800 transition-colors rounded-none h-14 text-[10px] uppercase tracking-[0.4em] font-bold">
            {language === 'he' ? 'היכנס' : 'Sign In'}
          </Button>
        </form>
        ...
        <div className="flex flex-col gap-4">
          <Button 
            ...
            className="w-full rounded-none border-zinc-300 h-14 flex items-center justify-center gap-4 hover:bg-zinc-50"
          >
            ...
            <span className="text-[10px] uppercase tracking-widest font-bold font-serif">Google</span>
          </Button>
          <Button 
            type="button" 
            variant="outline" 
          ...
          >
            ...
            <span className="text-[10px] uppercase tracking-widest font-bold font-serif">Facebook</span>
          </Button>
        </div>
      </motion.div>
    </div>
